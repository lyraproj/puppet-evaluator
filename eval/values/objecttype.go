...
func NewObjectType2(initHash map[string]interface{}) *ObjectType {
	result := &ObjectType{}
	result.Pcore_initFromHash(initHash)
	return result
}

func NewObjectType3(initHash map[string]interface{}, loader Loader) *ObjectType {
	result := &ObjectType{}
	result.Pcore_initFromHash(initHash)
...
func (t *ObjectType) Pcore_initFromHash(initHash map[string]interface{}) {
